<template>
  <div @keyup.enter="onsubmit">
    <el-form :inline="true" ref="form" :model="form" label-width="5rem">
    ...
    <el-table :data="tableData" highlight-current-row border height="400" style="width: 100%">
      <el-table-column label="课程名" width="200px">
      ...
      <el-table-column prop="teachname" label="教师" width="80">
      </el-table-column>
      <el-table-column prop="courseno" label="课程号" width="100">
      </el-table-column>
      <el-table-column prop="credit" label="学分" width="80">
      </el-table-column>
      <el-table-column prop="coursetime" label="时间" width="150">
      </el-table-column>
